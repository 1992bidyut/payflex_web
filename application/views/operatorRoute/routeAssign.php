    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i><?php echo $userIdName['username']."'".'s Route List';?>  </div>
                <div class="actions">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="odd gradeX">
                                ...
                                <input type="hidden" value="<?php echo $userIdName['id'] ;?>" name="cd_user_id">
                                ...
                                <td >
                                    <div class="clearfix">
                                        ...
                                        <a href="<?php echo base_url('OperatorRoute/deleteUserAssignedRoute/').$userRoute['operatorUserTblId'].'/'.$userIdName['id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-sm red"> Delete
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Add Route </div>
                <div class="actions">
                    <a href="javascript:;" class="btn btn-default btn-sm">
                        <i class="fa fa-plus"></i> Add </a>
                    <a href="javascript:;" class="btn btn-default btn-sm">
