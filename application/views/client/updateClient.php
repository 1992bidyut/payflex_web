...
<div class="row">
    <div class="col-md-12">
        <form
                action="<?php echo base_url('client/updateClient/' . $client['id']); ?>"
                method="POST"
        >
            <!--			Distributor name-->
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input
                                ...
                                value="<?php echo set_value('name', $client['name']); ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input
                                ...
                                value=""
                                id="client_representative_name"
                                class="form-control"
                                placeholder="Representative Name"
                                value="<?php echo set_value('representative_name', $client['representative_name']); ?>"
                                aria-describedby="helpId"
                        />
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-6">
                        <label for="client_code" class="form-label text-left"
                        >Client Code:</label
                        >
                    </div>
                    <div class="col-md-6">
                        <input
                                ...
                                value="<?php echo set_value('client_code', $client['client_code']); ?>"
                                aria-describedby="helpId"
                        />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-6">
                        <label for="virtual_account_no" class="form-label text-left"
                        >Virtual A/C No:</label
                        >
                    </div>
                    <div class="col-md-6">
                        <input
                                ...
                                value="<?php echo set_value('virtual_account_no', $client['virtual_account_no']); ?>"
                                aria-describedby="helpId"
                        />
                    </div>
                </div>
