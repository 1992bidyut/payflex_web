        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i> <?php if(!empty($this->session->userdata('lastExcelFileOwnerUser'))) echo 'SMS of &nbsp'.$this->session->userdata('lastExcelFileOwnerUser');
                        else{echo 'All SMS';}?> </div>
                    <div class="actions">
                        <a href="<?php echo base_url('SendSMS/smsExcelStoreConfirm');?>" class="btn green-haze btn-sm">
