...
class Credit extends CI_Controller{
    ...
    public function addCredit(){
		...
		$new_credit = $this->input->post('newCredit');
		$cd_user_id = $this->input->post('cdUserId');
        ...
        if($affected_rows)
        {
            ...
            if($insert_id)
            {
				...
				$username = $this->credit_model->getUsernameById($cd_user_id);
										
				$emailurl= "http://www.jhorotek.com/phpmailer/examples/user_add_credit.php?username=$username->username&credit=$new_credit";
