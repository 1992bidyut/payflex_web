...
class ActOnOutboxTest extends CI_Controller{
						...
						// die('ActCI@49');
							...
							else
							{
								...
								else
								{
									...
									//If credit is below 8, send an email
									if(($newRemainingCredit < 8) && ($newRemainingCredit > 7.3)) 
									{
										$username = $this->actOnOutbox_model->getUsernameById($cd_user_id);										
										$emailurl= "http://www.jhorotek.com/phpmailer/examples/user_low_credit.php?username=$username->username&credit=$newRemainingCredit";
